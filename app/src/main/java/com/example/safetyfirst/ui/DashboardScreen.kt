                ...
                Box(
                    ...
                    Text(
                        if (vpnOn)
                            ...
                            "Turn on the VPN to see activity."
                    )
                }
...
private fun EventRow(event: GatewayEvent) {
    ...
    val color = when {
        ...
        event.verdict.startsWith("BLACKLIST") ->
            Color(0xFFB00020)

        event.verdict.startsWith("PHISHING") ->
            Color(0xFFB00020)

        event.verdict.startsWith("SUSPICIOUS") ->
            Color(0xFFB26A00)
